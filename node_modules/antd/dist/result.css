...
.ant-btn-group .ant-btn-primary:not(:first-child):not(:last-child) {
  border-right-color: #ff73d3;
  border-left-color: #ff73d3;
}
...
.ant-cascader-picker:focus .ant-cascader-input {
  ...
  outline: 0;
  box-shadow: 0 0 0 2px rgba(255, 74, 205, 0.2);
}
...
.ant-picker-cell-in-view.ant-picker-cell-range-hover:not(.ant-picker-cell-in-range)::after {
  ...
  z-index: 0;
  height: 24px;
  border-top: 1px dashed #ffb0e9;
  border-bottom: 1px dashed #ffb0e9;
  transform: translateY(-50%);
  transition: all 0.3s;
  content: '';
}
...
.ant-picker-cell-in-view.ant-picker-cell-range-hover-end::after {
  right: 6px;
  border-right: 1px dashed #ffb0e9;
  border-top-right-radius: 2px;
  border-bottom-right-radius: 2px;
}
...
.ant-menu-horizontal:not(.ant-menu-dark) > .ant-menu-submenu-selected::after {
  border-bottom: 2px solid #ff4acd;
}
.ant-menu-horizontal > .ant-menu-item,
.ant-menu-horizontal > .ant-menu-submenu {
  position: relative;
...
.ant-radio-input:focus + .ant-radio-inner {
  box-shadow: 0 0 0 3px rgba(255, 74, 205, 0.08);
}
...
.ant-slider-handle-dragging.ant-slider-handle-dragging.ant-slider-handle-dragging {
  border-color: #ff6ed7;
  box-shadow: 0 0 0 5px rgba(255, 74, 205, 0.12);
}
